...
<?php
    ...
    if($_POST){
        ...
        $clave = (int) $_POST['clave']; // Recogemos el valor introducido en la variable clave para trabajar con él.
        ...
        try {
            ...
            else if (!is_numeric($clave) || is_numeric($clave))

                throw new Exception ("Uno de los campos no es valido.");


            else {
                if($nombre === "Maximiliano" || esNumSuerte($clave))
                    echo "Bienvenido Max!";
